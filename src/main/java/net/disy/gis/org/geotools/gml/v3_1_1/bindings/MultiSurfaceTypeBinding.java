 ...
 * @generated
 *
 * @source $URL: http://svn.osgeo.org/geotools/tags/2.6.5/modules/extension/xsd/xsd-gml3/src/main/java/org/geotools/gml3/bindings/MultiSurfaceTypeBinding.java $
 */
public class MultiSurfaceTypeBinding extends AbstractComplexBinding {
  ...
  public Object parse(ElementInstance instance, Node node, Object value) throws Exception {
    //&lt;element maxOccurs="unbounded" minOccurs="0" ref="gml:surfaceMember"/&gt;
    List<Polygon> surfaces = BindingUtilities.getSurfaces(node);
    return gf.createMultiPolygon(surfaces.toArray(Polygon[]::new));
  }
