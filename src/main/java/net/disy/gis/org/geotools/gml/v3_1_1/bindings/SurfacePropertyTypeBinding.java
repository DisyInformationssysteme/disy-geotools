 ...
 * @generated
 *
 * @source $URL: http://svn.osgeo.org/geotools/tags/2.6.5/modules/extension/xsd/xsd-gml3/src/main/java/org/geotools/gml3/bindings/SurfacePropertyTypeBinding.java $
 */
public class SurfacePropertyTypeBinding extends AbstractComplexBinding {

  private final GeometryFactory gf;

  public SurfacePropertyTypeBinding(GeometryFactory gf) {
    this.gf = gf;
  }
  ...
  public Object parse(ElementInstance instance, Node node, Object value) throws Exception {
    if (node.getChildValue(MultiPolygon.class) != null) {
      return new MultiSurfaceTypeBinding(gf).parse(instance, node, value);
    }
